...
const createUpdateObject = async (amount) => {
  ...
  const transactionObject = {
    ...
    data: myContract.methods
      .withdraw(amount).encodeABI()
  }

  return transactionObject
}

export const withdrawFunds = async (amount, txId) => {
  const txObject = await createUpdateObject(amount)
