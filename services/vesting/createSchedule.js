...
const createUpdateObject = async (address, startTime, cliffTime, duration, slicePeriod, revocable, amount) => {
  ...
  const transactionObject = {
    ...
    data: myContract.methods
      .createVestingSchedule(address, startTime, cliffTime, duration, slicePeriod, revocable, amount).encodeABI()
  }

  return transactionObject
}

export const createVestingSchedule = async (address, startTime, cliffTime, duration, slicePeriod, revocable, amount, txId) => {
  const txObject = await createUpdateObject(address, startTime, cliffTime, duration, slicePeriod, revocable, amount)
