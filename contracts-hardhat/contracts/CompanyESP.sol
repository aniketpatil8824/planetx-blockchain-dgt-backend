 ...
 */
 ...
 contract CompanyESP is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    struct Score{
        bytes32 root;
        bytes32[] proof;
    }
    mapping (bytes32 => uint256) private latestScore;
    mapping (bytes32 => uint256[]) private timeStamps;
    mapping (bytes32 => mapping (uint256 => Score)) private userBalance;
    
    function initialize() public virtual initializer {
        __companyESPscoreUpgradable_init();
    }

    function __companyESPscoreUpgradable_init() internal initializer {
        __Ownable_init();
    ...
    */
    ...
    function updatePoints(bytes32 _beneficiary ,bytes32 _root, bytes32[] memory _proof, uint256 _timestamp)
        ...
        onlyOwner
       {
        require(_timestamp > latestScore[_beneficiary], "Time Mismatch. Could not update previous points");
        ...
        latestScore[_beneficiary] = _timestamp;
    }
    ...
    */
    ...
    returns (bool){
        uint256 previousTime = latestScore[_beneficiary];
